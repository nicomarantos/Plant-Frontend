            ...
            <div class="card-body" >
             ...
             <div class =" mb-1 card-text">
               <button type="button" class="btn btn-success">Erfahre Mehr</button>
                <p></p>
                <button type="submit" class="btn btn-primary btn-sm" @click="savePlant(plant)">add to Wateringchecklist <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-droplet" viewBox="0 0 16 16">
